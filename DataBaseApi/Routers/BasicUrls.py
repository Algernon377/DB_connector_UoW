...
async def basic_set(name_table: TableName, get_dict: RequestGet):
...
async def basic_set(name_table: TableName, set_many_list: RequestSetMany):
...
async def basic_set(name_table: TableName, put_dict: RequestUpdate):
